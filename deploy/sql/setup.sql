...
CREATE TABLE clusters (
    cluster_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
-- CREATE ORGANIZATION --
INSERT INTO organizations (organization_name) VALUES ('test2');
CREATE UNIQUE INDEX unique_org_jobs_2
    ON jobs (job_name)
...
INSERT INTO jobs (job_name, organization_id, cluster_id) VALUES ('test', 2, 1);
